    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                ...
                <a href="{{ route('qualification.create') }}"><button class="btn btn-info pull-right"><i class="fas fa-plus"></i> Add</button></a>
            </div>
            <div class="ibox-body">
                <table class="table table-striped table-bordered table-hover" id="data-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                 	@foreach($qualifications as $key => $service)
	            		<tr>
	            			<td>{{ ++$key }}
	              			...
	              			<td>
	              				<ul class="actions-menu">
	              					<li>
	              						<a href="{{ route('qualification.edit',['id' => $service->id]) }}">
	              							<button class="btn-sm btn-primary btn-cir" title="Edit"><i class="fas fa-pencil-alt"></i></button>
	              						</a>
	              					</li>
	              					<li>
	              						<a href="{{ route('qualification.show',['id' => $service->id]) }}">
	              							<button class="btn-sm btn-warning btn-cir" title="View"><i class="fas fa-eye"></i></button>
	              						</a>
	              					</li>
	              					<li>
	              						<form action="{{ url('/admin/qualification/'.$service->id) }}" method="POST" onsubmit="deleteService('{{ $service->id }}', '{{ $service->title }}', event,this)">
	                    				@csrf
