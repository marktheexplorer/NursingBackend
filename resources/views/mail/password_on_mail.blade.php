...
<tbody>
    ...
    }else if($objDemo->type == 'password_on_mail'){?>
        <tr>
            <td>
                <p style="color: #555;line-height: 25px;margin: 0;">Congrates !!!, You are receiving this email because 24*7 Nursing Admin Create your account.</p><br/><br/>
            </td>
        </tr>
        <tr>
            <td>
                <p style="color: #555;line-height: 25px;margin: 0;">You can login 24*7 Nursing App with following credentials.</p>
                <p style="color: #555;line-height: 25px;margin: 0;">Email : <strong>{{ $objDemo->email }}</strong></p>
                <p style="color: #555;line-height: 25px;margin: 0;">Password : <strong>{{ $objDemo->password }}</strong></p>
            </td>
        </tr><?php
   } ?>
   <tr>
